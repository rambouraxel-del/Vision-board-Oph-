...
const DECO: Item[] = [
  ...
  },
  {
    ...
    title: 'Maison lumineuse et habitée',
    description: 'Plantes, objets chinés et lumière naturelle : une maison chaleureuse et vivante.',
    cat: 'cat-deco-salon',
    tags: ['bohème', 'lumière'],
  },
  {
  ...
  },
  {
    ...
    description: 'Draps de lin froissés, fenêtre ouverte et plantes au balcon : le calme du matin.',
    cat: 'cat-deco-chambre',
    tags: ['lin', 'minimaliste', 'crème'],
  },
  {
    key: 'deco-chambre-campagne',
    title: 'Chambre à la toile de Jouy',
    description: 'Voilages légers, lit ancien et imprimé traditionnel pour une chambre de maison de famille.',
    cat: 'cat-deco-chambre',
  ...
  {
    key: 'deco-terrasse',
    title: 'Terrasse de village',
    description: 'Une table simple, quelques fleurs et la vue : l’envie de repas dehors.',
  ...
  },
  {
    ...
    title: 'Mas provençal',
    description: 'Murs clairs, cyprès et volets peints : le charme d’un mas du sud.',
    cat: 'cat-deco-exterieur',
...
const DRESS: Item[] = [
  { key: 'dress-chemise-lin', title: 'Blouse blanche brodée', cat: 'cat-dress-hauts', color: 'Blanc cassé', season: 'Printemps-été' },
  { key: 'dress-tshirt', title: 'Marinière', cat: 'cat-dress-hauts', color: 'Bleu et blanc', season: 'Toutes saisons' },
  { key: 'dress-cardigan', title: 'Cardigan torsadé', cat: 'cat-dress-mailles', color: 'Crème', season: 'Mi-saison' },
  { key: 'dress-pull', title: 'Pull rayé en maille', cat: 'cat-dress-mailles', color: 'Taupe', season: 'Automne-hiver' },
  { key: 'dress-jean', title: 'Jean brut', cat: 'cat-dress-bas', color: 'Bleu', season: 'Toutes saisons' },
  { key: 'dress-jupe-midi', title: 'Jupe fleurie en tulle', cat: 'cat-dress-bas', color: 'Rose poudré', season: 'Printemps-été' },
  { key: 'dress-robe-fleurie', title: 'Robe blanche fleurie', cat: 'cat-dress-robes', color: 'Blanc', season: 'Printemps-été' },
  { key: 'dress-trench', title: 'Trench', cat: 'cat-dress-vestes', color: 'Beige', season: 'Mi-saison' },
  { key: 'dress-ballerines', title: 'Ballerines', cat: 'cat-dress-chaussures', color: 'Corail', season: 'Printemps-été' },
  { key: 'dress-baskets', title: 'Baskets en toile blanche', cat: 'cat-dress-chaussures', color: 'Blanc', season: 'Toutes saisons' },
  { key: 'dress-panier', title: 'Panier tressé', cat: 'cat-dress-accessoires', color: 'Naturel', season: 'Printemps-été' },
  { key: 'dress-foulard', title: 'Foulard en soie', cat: 'cat-dress-accessoires', color: 'Rose', season: 'Toutes saisons' },
].map((d, i) =>
  make({
    id: `seed-${d.key}`,
    type: 'vetement',
